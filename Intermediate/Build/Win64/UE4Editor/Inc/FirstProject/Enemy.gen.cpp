...
// End Cross Module References
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_EnemyAttackAnimationPlayRate_MetaData[];
#endif
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_EnemyAttackAnimationPlayRate;
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AEnemy_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_AEnemy_AggroSphereOnOverlapBegin, "AggroSphereOnOverlapBegin" }, // 1946686563
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AEnemy_Statics::NewProp_AggroSphere_MetaData[] = {
		{ "Category", "AI" },
		{ "Comment", "/** The enemy will start chasing the player when the player overlaps with this sphere */" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Enemy.h" },
		{ "ToolTip", "The enemy will start chasing the player when the player overlaps with this sphere" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AEnemy_Statics::NewProp_CombatSphere_MetaData[] = {
		{ "Category", "AI" },
		{ "Comment", "/** This smaller sphere will be used for the enemy to start attacking when the player overlaps with it */" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Enemy.h" },
		{ "ToolTip", "This smaller sphere will be used for the enemy to start attacking when the player overlaps with it" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AEnemy_Statics::NewProp_AIController_MetaData[] = {
		{ "Category", "AI" },
		{ "Comment", "/** AI Move To function is called from the AI controller so we are getting a reference to that */" },
		{ "ModuleRelativePath", "Enemy.h" },
		{ "ToolTip", "AI Move To function is called from the AI controller so we are getting a reference to that" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AEnemy_Statics::NewProp_HitParticles_MetaData[] = {
		{ "Category", "AI" },
		{ "Comment", "/** Particle system for when the enemy gets hit */" },
		{ "ModuleRelativePath", "Enemy.h" },
		{ "ToolTip", "Particle system for when the enemy gets hit" },
	};
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AEnemy_Statics::NewProp_EnemyAttackAnimationPlayRate_MetaData[] = {
		{ "Category", "Combat" },
		{ "ModuleRelativePath", "Enemy.h" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AEnemy_Statics::NewProp_EnemyAttackAnimationPlayRate = { "EnemyAttackAnimationPlayRate", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AEnemy, EnemyAttackAnimationPlayRate), METADATA_PARAMS(Z_Construct_UClass_AEnemy_Statics::NewProp_EnemyAttackAnimationPlayRate_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AEnemy_Statics::NewProp_EnemyAttackAnimationPlayRate_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AEnemy_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AEnemy_Statics::NewProp_EnemyAttackAnimationPlayRate,
