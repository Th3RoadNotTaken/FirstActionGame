...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFloatingPlatform_Statics::NewProp_Mesh_MetaData[] = {
		{ "Category", "Platform" },
		{ "Comment", "/** Mesh for the floating platform */" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "FloatingPlatform.h" },
		{ "ToolTip", "Mesh for the floating platform" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFloatingPlatform_Statics::NewProp_StartPoint_MetaData[] = {
		{ "Category", "Platform" },
		{ "Comment", "/** Defining start and end points for the floating platform */" },
		{ "ModuleRelativePath", "FloatingPlatform.h" },
		{ "ToolTip", "Defining start and end points for the floating platform" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFloatingPlatform_Statics::NewProp_EndPoint_MetaData[] = {
		{ "Category", "Platform" },
		{ "Comment", "// MakeEditWidget - Visualization widget to manipulate in the editor\n" },
		{ "MakeEditWidget", "true" },
		{ "ModuleRelativePath", "FloatingPlatform.h" },
		{ "ToolTip", "MakeEditWidget - Visualization widget to manipulate in the editor" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFloatingPlatform_Statics::NewProp_InterpSpeed_MetaData[] = {
		{ "Category", "Platform" },
		{ "Comment", "/** Speed for the interpolation from start to end point of the platform */" },
		{ "ModuleRelativePath", "FloatingPlatform.h" },
		{ "ToolTip", "Speed for the interpolation from start to end point of the platform" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AFloatingPlatform_Statics::NewProp_InterpSpeed = { "InterpSpeed", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AFloatingPlatform, InterpSpeed), METADATA_PARAMS(Z_Construct_UClass_AFloatingPlatform_Statics::NewProp_InterpSpeed_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AFloatingPlatform_Statics::NewProp_InterpSpeed_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFloatingPlatform_Statics::NewProp_InterpTime_MetaData[] = {
		{ "Category", "Platform" },
		{ "Comment", "/** Time for interpolation timer */" },
		{ "ModuleRelativePath", "FloatingPlatform.h" },
		{ "ToolTip", "Time for interpolation timer" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AFloatingPlatform_Statics::NewProp_InterpTime = { "InterpTime", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AFloatingPlatform, InterpTime), METADATA_PARAMS(Z_Construct_UClass_AFloatingPlatform_Statics::NewProp_InterpTime_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AFloatingPlatform_Statics::NewProp_InterpTime_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(AFloatingPlatform, 4090626045);
