...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFloorSwitch_RaiseDoor_Statics::Function_MetaDataParams[] = {
		{ "Category", "FloorSwitch" },
		{ "Comment", "// BlueprintImplementableEvent means you can implement the functionality in the blueprint\n" },
		{ "ModuleRelativePath", "FloorSwitch.h" },
		{ "ToolTip", "BlueprintImplementableEvent means you can implement the functionality in the blueprint" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFloorSwitch_Statics::NewProp_FloorSwitch_MetaData[] = {
		{ "Category", "FloorSwitch" },
		{ "Comment", "/** The switch for the character to step on */" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "FloorSwitch.h" },
		{ "ToolTip", "The switch for the character to step on" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFloorSwitch_Statics::NewProp_Door_MetaData[] = {
		{ "Category", "FloorSwitch" },
		{ "Comment", "/** Door to open when floor switch is stepped on */" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "FloorSwitch.h" },
		{ "ToolTip", "Door to open when floor switch is stepped on" },
	};
#endif
