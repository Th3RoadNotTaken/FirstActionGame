...
// End Cross Module References
	...
	{
		P_GET_PROPERTY(FIntProperty,Z_Param_CoinCount);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->IncrementCoins(Z_Param_CoinCount);
		P_NATIVE_END;
	}
	...
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UFunction_AMain_IncrementCoins_Statics::NewProp_CoinCount = { "CoinCount", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Main_eventIncrementCoins_Parms, CoinCount), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AMain_IncrementCoins_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AMain_IncrementCoins_Statics::NewProp_CoinCount,
	};
#if WITH_METADATA
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_InvalidSelectionSound_MetaData[];
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_InvalidSelectionSound;
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AMain_Statics::NewProp_InvalidSelectionSound_MetaData[] = {
		{ "Category", "Widgets" },
		{ "ModuleRelativePath", "Main.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AMain_Statics::NewProp_InvalidSelectionSound = { "InvalidSelectionSound", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AMain, InvalidSelectionSound), Z_Construct_UClass_USoundCue_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AMain_Statics::NewProp_InvalidSelectionSound_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AMain_Statics::NewProp_InvalidSelectionSound_MetaData)) };
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AMain_Statics::NewProp_bHasCombatTarget_MetaData[] = {
		{ "Category", "Combat" },
		{ "Comment", "/** Boolean to enable or disable the enemy health bar*/" },
		{ "ModuleRelativePath", "Main.h" },
		{ "ToolTip", "Boolean to enable or disable the enemy health bar" },
	};
#endif
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AMain_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AMain_Statics::NewProp_InvalidSelectionSound,
	...
	IMPLEMENT_CLASS(AMain, 3034035051);
