...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ASpawnVolume_GetSpawnPoint_Statics::Function_MetaDataParams[] = {
		{ "Category", "Spawning" },
		{ "Comment", "// BlueprintPure means that if we call this function from a BP, we will only have the return value from it\n" },
		{ "ModuleRelativePath", "SpawnVolume.h" },
		{ "ToolTip", "BlueprintPure means that if we call this function from a BP, we will only have the return value from it" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ASpawnVolume_SpawnOurActor_Statics::Function_MetaDataParams[] = {
		{ "Category", "Spawning" },
		{ "Comment", "// BlueprintNativeEvent means that we will script this out both in C++ and BP\n" },
		{ "ModuleRelativePath", "SpawnVolume.h" },
		{ "ToolTip", "BlueprintNativeEvent means that we will script this out both in C++ and BP" },
	};
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ASpawnVolume_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_ASpawnVolume_GetSpawnPoint, "GetSpawnPoint" }, // 1928842743
		{ &Z_Construct_UFunction_ASpawnVolume_SpawnOurActor, "SpawnOurActor" }, // 462109379
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ASpawnVolume_Statics::NewProp_SpawningBox_MetaData[] = {
		{ "Category", "Spawning" },
		{ "Comment", "/** We will spawn creatures randomly in this box */" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "SpawnVolume.h" },
		{ "ToolTip", "We will spawn creatures randomly in this box" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ASpawnVolume_Statics::NewProp_Actor_2_MetaData[] = {
		{ "Category", "Spawning" },
		{ "Comment", "// Technically getting a BP of a variable (Here we are getting an Actor)\n" },
		{ "ModuleRelativePath", "SpawnVolume.h" },
		{ "ToolTip", "Technically getting a BP of a variable (Here we are getting an Actor)" },
	};
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ASpawnVolume_Statics::NewProp_SpawnRotation_MetaData[] = {
		{ "Category", "Spawning" },
		{ "ModuleRelativePath", "SpawnVolume.h" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_ASpawnVolume_Statics::NewProp_SpawnRotation = { "SpawnRotation", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ASpawnVolume, SpawnRotation), Z_Construct_UScriptStruct_FRotator, METADATA_PARAMS(Z_Construct_UClass_ASpawnVolume_Statics::NewProp_SpawnRotation_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ASpawnVolume_Statics::NewProp_SpawnRotation_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ASpawnVolume_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ASpawnVolume_Statics::NewProp_SpawnRotation,
	};
	...
	IMPLEMENT_CLASS(ASpawnVolume, 459879471);
