...
{
	GENERATED_BODY() // Required for structs to take part in UE's reflection system
...
public:
	...
	/** Category basic is required for variables you want to save */
	UPROPERTY(VisibleAnywhere, Category = Basic)
	FString PlayerName;
	UPROPERTY(VisibleAnywhere, Category = Basic)
	uint32 UserIndex; // Save slot
